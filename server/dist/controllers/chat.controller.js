...
exports.getStreamUpdates = exports.getGallery = exports.updateChatTitle = exports.deleteChat = exports.stopStream = exports.streamMessage = exports.getChatById = exports.getAllChats = exports.sendMessage = exports.createChatStream = exports.createChat = void 0;
...
exports.getGallery = (0, asyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const gallery = yield chat_service_1.chatService.getGallery(String(req.params.id || req.params.userId));
