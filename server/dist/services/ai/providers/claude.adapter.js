...
class ClaudeAdapter {
    constructor() {
        this.model = constants_1.AI_PROVIDERS.CLAUDE.models[0];
    }
    getProviderName() {
        return (0, constants_1.getDisplayProviderName)(constants_1.AI_PROVIDERS.CLAUDE.id, this.model);
    }
    setModel(model) {
        this.model = model;
    }
    ...
    generateStreamResponse(messages) {
        return __asyncGenerator(this, arguments, function* generateStreamResponse_1() {
            ...
            for (const word of mockText.split(" ")) {
                ...
                yield __await(new Promise((resolve) => setTimeout(resolve, 80)));
            }
        });
    }
}
