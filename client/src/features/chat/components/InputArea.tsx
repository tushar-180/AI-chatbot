          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 rounded-2xl border border-white/10 bg-slate-900/80 p-3 md:p-4 shadow-[0_20px_50px_rgba(0,0,0,0.5)] transition-all duration-300 backdrop-blur-2xl">
            <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                <h4 className="text-[11px] font-bold text-white uppercase tracking-[0.15em] mb-0.5">Archived Session</h4>
                <p className="text-[10px] text-slate-500 font-medium leading-tight">This conversation is preserved in the vault.</p>
              </div>
            </div>
            <button
              onClick={onUnarchive}
