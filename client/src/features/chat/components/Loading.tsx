...
export default function Loading({ message = "Starting AI" }: LoadingProps) {
  return (
    <div className="flex flex-col items-center justify-center h-screen w-full bg-[#09090b]">
      <div className="relative flex flex-col items-center gap-6">
        ...
        <p className="text-[9px] font-bold tracking-[0.5em] text-zinc-500 uppercase animate-in fade-in duration-1000">
          {message}
        </p>
