...
// Import Prism light languages to reduce bundle size and main-thread block time
...
import html from "react-syntax-highlighter/dist/esm/languages/prism/markup"; // prism html uses markup
