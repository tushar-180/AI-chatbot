      ...
      <div className="relative flex h-full max-h-[800px] w-full max-w-5xl flex-col overflow-hidden rounded-[2.5rem] border border-white/10 bg-[#030712] shadow-2xl animate-in zoom-in-95 duration-300">
        ...
        <div className="flex items-center justify-between border-b border-white/5 px-8 py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl font-bold tracking-tight text-white">Multimedia Gallery</h2>
              <p className="text-xs font-bold uppercase tracking-[0.2em] text-slate-500">
                {items.length} {items.length === 1 ? 'Asset' : 'Assets'} Uploaded
              </p>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-8 custom-scrollbar">
          {loading ? (
            <div className="flex h-64 flex-col items-center justify-center gap-4">
              ...
              <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-slate-600">Syncing Assets...</p>
            </div>
          ) : error ? (
            ...
            <div className="flex h-64 flex-col items-center justify-center gap-4 opacity-40">
              ...
              <p className="text-[10px] font-bold uppercase tracking-[0.3em]">No assets found in your history</p>
            </div>
          ) : (
